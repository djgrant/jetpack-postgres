...
truncate jetpack.nodes restart identity cascade; 
...
select jetpack.create_node('ETL instance 1', '5d20f471-2140-4bea-b83f-3d11d030e94a', null, '2');
select jetpack.create_node('ETL instance 2', '5d20f471-2140-4bea-b83f-3d11d030e94a', 1, '2');
select jetpack.create_node('ETL 2 instance 1', '5d20f471-2140-4bea-b83f-3d11d030e94a', null, '2');
